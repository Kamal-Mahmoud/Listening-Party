    ...
    @elseif($isFinished)
        <div class="flex items-center justify-center min-h-screen bg-emerald-50">
            <div class="w-full max-w-2xl p-8 mx-8 text-center bg-white rounded-lg shadow-lg">
                <h2 class="mb-4 font-serif text-2xl font-bold text-slate-900">This listening party has finished 👋🏻
                </h2>
            ...
            <div class="relative w-full max-w-2xl p-6 bg-white rounded-lg shadow-lg">
                <div class="flex items-center space-x-4">
                    <div class="flex-shrink-0">
                        <x-avatar src="{{ $listeningParty->episode->podcast->artwork_url }}" size="2xl"
                    ...
                    <div class="w-full space-y-6">
                        <div class="p-6 bg-white rounded-lg shadow-lg">
                            <div class="flex items-center mb-6 space-x-4">
                                ...
                                <div class="mb-6" x-show="!isLoading">
                                    <div class="flex items-center justify-between mb-2">
                                        <span x-text="formatTime(currentTime)" class="text-sm text-slate-700"></span>
                                    ...
                                    <div class="h-2 rounded-full bg-emerald-100 w-24">
                                        <div class="h-2 rounded-full bg-emerald-500"
                                            :style="`width: ${(currentTime / audio.duration) * 100}%`"></div>
                                    </div>
                                    <x-button pause   class=" p-3 mt-3 w-full">Pause</x-button>
                                </div>
                                <div x-show="!isPlaying" class="mt-6">
                                    <x-button @click="joinAndBeReady()" class="w-full" primary
                                        label="Join Listening Party" />
                                </div>
